...
状态：完成透明整理、人工锚点对齐、UE 导入与正式战斗接入；第 41E 批已替换游戏默认五动作。

第 41D 批增加攻击/受击/死亡资产及独立预览，完整来源和可复现整理见 [动作生成记录](Actions-v1.md)。第 41E 批完成五动作统一默认引用、接触帧同步与死亡/复活实测，见 `Docs/Step41E_PixelPlayerCombat.md`。这不代表怪物、宠物或 Boss 的动画重制完成。
